...
if not (syn or Krnl or IsElectron) then
	warn("Exploit Function Not Supported")
	...
	wait(6)
	Player:Kick("DarkOni: Unsupported Exploit")
	wait(8.8)
	game:Shutdown()
end
...
if Player.UserId == nil then
    ...
    Window = Library:CreateWindow('D A R K O N I  ', 'V 6 . 9 [Dark Version]\nUnsupported', 'D A R K  O N I\nWelcome: '.. UserName..'\n Game: ???', '', 'OniConfigs', 'Default')
	Library:SetTransparency(50 / 100, true)
	Library:CreatePrompt('OneButton', 'DarkOni', 'Hey! '.. UserName..' Youre Blacklisted\n Reason: Violated Our Rules', {
		':(', function()
		   Library:CreateNotification("DarkOni | Notifications", "DarkOni: Blacklisted, Username: ".. UserName.."\n Appeal: No.", 3)
           Library:DestroyUI()
		end
	})
	return
...
if game.PlaceId ~= 5712833750 then
	...
	Library:CreatePrompt('OneButton', 'DarkOni', 'Hey there! '.. UserName..'\n This is an unsupported Game!', {
		'Okay', function()
		    Library:CreateNotification("DarkOni | Notifications", "Alr Enjoy The Game You Play.", 3)
			Library:DestroyUI()
		end
	})
    Library:CreateNotification("DarkOni | Notifications", "Unsuported Game | Code: 0xx221", 10)
...
-- [[ UI Library Setup ]]
Library = loadstring(game:HttpGet('https://raw.githubusercontent.com/VoixGIT/ONIHUB/main/VisualUI3.0'))()
Window = Library:CreateWindow('D A R K O N I ', 'V 6 . 9 [Dark Version]\nAnimal Simulator', 'D A R K O N I\nWelcome, '.. UserName..'\nGame: '.. GameName..'', '', _G.themeoptionincreaseFPS, 'OniConfigs', theme)

wait(2)
Library:CreateNotification("DarkOni | Notifications", "Some functions may not work right now", 5)
--Library:CreateNotification("DarkOni | Notifications", "Windows: Ill stop update this week.", 5)

game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer("All Hail Hisako!", "All")
...
if Player.UserId == 18125835 then
    Library:CreateNotification("DarkOni | Notifications", "Welcome Admin! | Name: ".. UsernameName.."", 10)
...
if Player.UserId == 3406999575 then
    Library:CreateNotification("DarkOni| Notifications", "Welcome Admin! | Name: ".. DisplayName.."", 10)
    ...
    task.spawn(function()
        while true do
            ...
            if TrackingWebhookSeconds == 0 then
                ...
                Library:CreateNotification("DarkOni | Notifications", "Sending/Updating Information To Discord", 3)
...
Button = Section:CreateButton('Create DARKONI Pack', function()
    game:GetService("Players").LocalPlayer.PlayerGui.TeamGUI.createFrame.bodyFrame.createButton.createTeamEvent:FireServer('✂️🩸-DARK-✂️🩸')
end)
...
Button = Section:CreateButton('Rejoin Server(Same)', function()
    Library:CreateNotification("DarkOni | Notifications", "Rejoin Server...", 4)
	wait(4)
...
Button = Section:CreateButton('Rejoin Server(Diff) Less Player', function()
    Library:CreateNotification("DarkOni | Notifications", "Joinning Diff Server | Less Player", 4)
	wait(4)
...
Paragraph = Section:CreateParagraph('Hisako', 'Fuck you Ragnar')
