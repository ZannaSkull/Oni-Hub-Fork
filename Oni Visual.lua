...
do
    ...
    function Library:CreateNotification(Title, Text, Duration)
        ...
        task.spawn(function()
            ...
            if not CoreGui:FindFirstChild('OniHub | Notifications') then
                Utility:Create('ScreenGui', {
                    Name = 'OniHub | Notifications',
                    Parent = CoreGui
                })
            else
                Utility:Create('Frame', {
                    Parent = CoreGui:FindFirstChild('OniHub | Notifications'),
                ...
                Amount = Amount + 1
                local Holder = CoreGui:FindFirstChild('OniHub | Notifications')['Notification'..tostring(Amount)]
...
function Library:SetTransparency(Transparency, NotificationBool)
    local UI = CoreGui:WaitForChild('OniHub')
    local Blacklist = {
        'UIPadding',
        'UICorner',
        'UIStroke',
